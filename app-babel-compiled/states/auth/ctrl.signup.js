...
(function () {
  ...
  angular.module('edhubJobsApp').controller('SignupCtrl', ['edhubAuthService', '$scope', function (edhubAuthService, $scope) {
    var vm = this;
    vm.email = "";
    vm.pw = "";
    vm.error = "";
    ...
    vm.userSignup = function () {
      edhubAuthService.userSignup(vm.email, vm.pw).then(function (auth) {
