...
(function (GeoFire) {
    ...
    function JuliusCtrlClass(edhubJobPostService, $http, $location, $firebaseArray) {
        ...
        //-- Start the map rendering process:
        getLocation();
        ...
        // this function gets invoked from within a callback
        function initMap() {
            let initMap = this;
            var localStoreData;
            let getLocalData = false;

            // analyze the structure of nodeClubs
            console.log("__>> Plamigo Log: analyze clubs node");
            console.log(nodeClubs);

            // MOVE $firebaseArray to its' own service and use the services
            // returned api to get the data !!!!!!
