...
(function () {
    ...
    angular.module('edhubJobsApp').controller('CoreCtrl', ['$rootScope', '$scope', '$mdSidenav', '$mdDialog', '$timeout', 'edhubAuthService', '$location', CoreClass]);
    ...
    function CoreClass($rootScope, $scope, $mdSidenav, $mdDialog, $timeout, edhubAuthService, $location) {
        ...
        $scope.ccItems = [{
            name: _determineAuthState(),
            icon: "login",
            direction: "left"
        }, {
            name: enumAuthBox.editProfile,
            icon: "edit",
            direction: "left"
        }, //{name: enumAuthBox.settings, icon: "settings", direction: "bottom"},
            {
                name: enumAuthBox.applications,
                icon: "view_list",
                direction: "left"
        ...
        $scope.ccOpenDialog = function ($event, item) {
            ...
            $mdDialog.show({
                ...
                controller: function controller($mdDialog) {
                    ...
                    this.item = item; // Setup some handlers
